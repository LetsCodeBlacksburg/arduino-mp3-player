...
//DFPlayer mp3 player
const int ardRX=10;       // The arduino software Receive line goes to DFPlayer TX(3)
...
int fileCount=12;         // Either set the max # of files here, or load it from myDFPlayer.readFileCounts()
                          // NOTE: readFileCounts() also sees deleted files. May need to reformat to load new sounds.
int setVol=15;            //Set volume value (0~30)
